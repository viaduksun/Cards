/******/ (() => {
  ...
  \*********************/
      /***/ (
        ...
        /* harmony import */ var _component_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          /*! ./component.js */ "./src/component.js"
        );
        /* harmony import */ var _ajax_api_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          /*! ./ajax/api.js */ "./src/ajax/api.js"
        );
        /* harmony import */ var _modal_Modal_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! ./modal/Modal.js */ "./src/modal/Modal.js"
        );
        /* harmony import */ var _Form_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          /*! ./Form.js */ "./src/Form.js"
        );
        /* harmony import */ var _editCardForm_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          /*! ./editCardForm.js */ "./src/editCardForm.js"
        );
        /* harmony import */ var _dragNDrop_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
          /*! ./dragNDrop.js */ "./src/dragNDrop.js"
        );
          ...
          _createClass(Card, [
            ...
            },
            {
              ...
              value: function showName() {
                ...
                var nameContainer = this.createElement("div", [
                  "name-container",
                ]);
            ...
            },
            {
              ...
              value: function showAllFields() {
                ...
                span.innerHTML =
                  '<span class="icon-chevron-up icon-config"></span>';
                ...
                filteredUserDataArr.forEach(function (item, i) {
                  var infoItem = _this2.createElement(
                    "span",
                    ["_info"],
                    item[1]
                  ...
                  var infoTitle = _this2.createElement(
                    "span",
                    ["_info-title"],
                    itemTitle
                  );
            ...
            },
            {
              ...
              value: function hideAllFields() {
                ...
                var span = document.createElement("span");
                span.innerHTML =
                  '<span class="icon-chevron-down icon-config"></span>';
                this.btnShowMore.append(span); //=============================
              },
            },
            {
              ...
              value: function renderBody() {
                ...
                this.addFields = this.createElement("div", [
            ...
            },
            {
              ...
              value: function renderFooter() {
                ...
                var priorityContainer = this.createElement(
                  "div",
                  ["priority-container"],
                  "Priority:"
                );
                var priorityDotsContainer = this.createElement("div", [
                ...
                if (this.userData.urgency === "Regular") {
                  ...
                  priorityDotsContainer.append(this.elem);
                  priorityDotsContainer.setAttribute(
                    "data-tooltip",
                    "Priority"
                  );
                  priorityDotsContainer.addEventListener(
                ...
                var btnOptions = this.createElement(
                  "button",
                  ["btn", "btn-options"],
                  "Options"
                );
                ...
                var cardMenuWrapper = this.createElement("div", [
                  "card-menu-wrapper",
                ]);
                ...
                var cardMenuConatainer = this.createElement("div", [
                  "card-menu",
                ]);
                var cardMenuBtnEdit = this.createElement(
                  "button",
                  ["btn", "btn-edit"],
                  "Edit card"
                );
                cardMenuBtnEdit.addEventListener("click", function (event) {
                  _modal_Modal_js__WEBPACK_IMPORTED_MODULE_2__.default.show(
                    "Create edit form",
                    _Form_js__WEBPACK_IMPORTED_MODULE_3__.createEditForm.render()
                  );
                  _Form_js__WEBPACK_IMPORTED_MODULE_3__.createEditForm.showGeneralFields();
                  _Form_js__WEBPACK_IMPORTED_MODULE_3__.createEditForm.showCustomeFields(
                    _this3.userData.visitType
                  );
                  _Form_js__WEBPACK_IMPORTED_MODULE_3__.createEditForm.showStatusSelect();
                  var form = document.querySelector(".form-container");
                  (0,
                  _editCardForm_js__WEBPACK_IMPORTED_MODULE_4__.editCardForm)(form, _this3.userData);
                });
                var cardMenuBtnDelete = this.createElement(
                  "button",
                  ["btn", "btn-delete"],
                  "Delete card"
                );
                cardMenuBtnDelete.addEventListener("click", function (event) {
                  ...
                  _modal_Modal_js__WEBPACK_IMPORTED_MODULE_2__.default.show(
                    "Delete card",
                    _Form_js__WEBPACK_IMPORTED_MODULE_3__.createDeleteCardForm.render()
                  );
                            ...
                            while (1) {
                              switch ((_context.prev = _context.next)) {
                                case 0:
                                  ...
                                  _context.next = 3;
                                  return (0,
                                  _ajax_api_js__WEBPACK_IMPORTED_MODULE_1__.getCards)();

                                case 3:
                                  cards = _context.sent;
                                  (0,
                                  _ajax_api_js__WEBPACK_IMPORTED_MODULE_1__.deleteVisitCard)(
                                    _this3.userData.id
                                  );
                                  targetCard.remove();
            ...
            },
            {
              ...
              value: function onmouseover(event) {
                ...
                var left =
                  coords.left +
                  (target.offsetWidth - tooltipElem.offsetWidth) / 2;
            ...
            },
            {
              ...
              value: function render() {
                ...
                this.visitCard = this.createElement("div", [
                  "card",
                  "user-card",
                ]);
                ...
                this.cardCell.addEventListener(
                  "dragover",
                  _dragNDrop_js__WEBPACK_IMPORTED_MODULE_5__.dragOver.bind(
                    this.cardCell
                  )
                );
                this.cardCell.addEventListener(
                  "dragenter",
                  _dragNDrop_js__WEBPACK_IMPORTED_MODULE_5__.dragEnter.bind(
                    this.cardCell
                  )
                );
                this.cardCell.addEventListener(
                  "dragleave",
                  _dragNDrop_js__WEBPACK_IMPORTED_MODULE_5__.dragLeave.bind(
                    this.cardCell
                  )
                );
                this.cardCell.addEventListener(
                  "drop",
                  _dragNDrop_js__WEBPACK_IMPORTED_MODULE_5__.dragDrop.bind(
                    this.cardCell
                  )
                );
                this.visitCard.addEventListener(
                  "dragstart",
                  _dragNDrop_js__WEBPACK_IMPORTED_MODULE_5__.dragStart.bind(
                    this.visitCard
                  )
                );
                this.visitCard.addEventListener(
                  "dragend",
                  _dragNDrop_js__WEBPACK_IMPORTED_MODULE_5__.dragEnd.bind(
                    this.visitCard
                  )
                );
  ...
  \*********************/
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          ...
          /* harmony export */ createRegisterForm: () =>
            /* binding */ createRegisterForm,
          /* harmony export */ createVisitForm: () =>
            /* binding */ createVisitForm,
          /* harmony export */ createDeleteCardForm: () =>
            /* binding */ createDeleteCardForm,
        ...
        /* harmony import */ var _formComponents_Input_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          /*! ./formComponents/Input.js */ "./src/formComponents/Input.js"
        );
        /* harmony import */ var _formComponents_Button_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! ./formComponents/Button.js */ "./src/formComponents/Button.js"
        );
        /* harmony import */ var _formComponents_Select_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          /*! ./formComponents/Select.js */ "./src/formComponents/Select.js"
        );
        /* harmony import */ var _formComponents_Textarea_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          /*! ./formComponents/Textarea.js */ "./src/formComponents/Textarea.js"
        );
        /* harmony import */ var _visit_Visit_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
          /*! ./visit/Visit.js */ "./src/visit/Visit.js"
        );
        /* harmony import */ var _visit_VisitCardiologist_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
          /*! ./visit/VisitCardiologist.js */ "./src/visit/VisitCardiologist.js"
        );
        /* harmony import */ var _visit_VisitDantist_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
          /*! ./visit/VisitDantist.js */ "./src/visit/VisitDantist.js"
        );
        /* harmony import */ var _visit_VisitTherapist_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
          /*! ./visit/VisitTherapist.js */ "./src/visit/VisitTherapist.js"
        );
        function _typeof(obj) {
          "@babel/helpers - typeof";
          if (
          ...
          _createClass(Form, [
            {
              ...
              value: function showDoctorSelect() {
                this.mainSelectblock = this.createElement("div", [
                  "form-select-block",
                ]);
                this.mainSelectblock.append(
                  _visit_Visit_js__WEBPACK_IMPORTED_MODULE_5__.generalFields.renderSelect()
                );
            ...
            },
            {
              ...
              value: function showGeneralFields() {
                ...
                this.generalFieldsContainer.append(
                  _visit_Visit_js__WEBPACK_IMPORTED_MODULE_5__.generalFields.renderFields()
                );
            ...
            },
            {
              ...
              value: function showCustomeFields(doctor) {
                if (doctor === "Cardiologist") {
                  this.customFields.append(
                    _visit_VisitCardiologist_js__WEBPACK_IMPORTED_MODULE_6__.cardiologistFields.render()
                  );
                } else if (doctor === "Dantist") {
                  this.customFields.append(
                    _visit_VisitDantist_js__WEBPACK_IMPORTED_MODULE_7__.dantistFields.render()
                  );
                } else if (doctor === "Therapist") {
                  this.customFields.append(
                    _visit_VisitTherapist_js__WEBPACK_IMPORTED_MODULE_8__.therapistFields.render()
                  );
                }
            ...
            },
            {
              ...
              value: function showStatusSelect() {
                this.customFields.append(
                  _visit_Visit_js__WEBPACK_IMPORTED_MODULE_5__.statusSelect.renderSelect()
                );
              },
            },
            {
              ...
              value: function render() {
                ...
                this.containerForm = this.createElement("form", [
                  "form",
                  "form-container",
                ]);
                this.customFields = this.createElement("div", [
                  "form-custome-fields",
                ]);
                this.generalFieldsContainer = this.createElement("div", [
                  "form-general",
                ]);
                this.btnElement = new _formComponents_Button_js__WEBPACK_IMPORTED_MODULE_2__.default(
                  this.btnSettings.classNames
                ).render();
                ...
                var items = this.config.map(function (configItem) {
                  ...
                  if (configItem.elType === "input") {
                    ...
                    element = new _formComponents_Button_js__WEBPACK_IMPORTED_MODULE_2__.default(
                      configItem.classNames
                    ).render();
                    element.textContent = configItem.innerText;
                    element.classList.add(configItem.className);
                  } else if (configItem.elType === "select") {
                    element = new _formComponents_Select_js__WEBPACK_IMPORTED_MODULE_3__.default(
                      configItem.options
                    ).render();
                  } else if (configItem.elType === "textarea") {
                    element = new _formComponents_Textarea_js__WEBPACK_IMPORTED_MODULE_4__.default(
                      configItem.options
                    ).render();
                    element.placeholder = configItem.placeholder;
                ...
                (_this$containerForm = this.containerForm).append.apply(
                  _this$containerForm,
  ...
  \*************************/
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          ...
          /* harmony export */ createVisitCard: () =>
            /* binding */ createVisitCard,
          /* harmony export */ deleteVisitCard: () =>
            /* binding */ deleteVisitCard,
        ...
        var getCard = /*#__PURE__*/ (function () {
          var _ref2 = _asyncToGenerator(
            /*#__PURE__*/ regeneratorRuntime.mark(function _callee2(cardId) {
        ...
        var createVisitCard = /*#__PURE__*/ (function () {
          var _ref3 = _asyncToGenerator(
            /*#__PURE__*/ regeneratorRuntime.mark(function _callee3(userData) {
  ...
  \**************************/
      /***/ (
        ...
        var dragDrop = function dragDrop(event) {
          ...
          var draggableCard = document.querySelector(
            '.card[userid="'.concat(cardId, '"]')
          );
  ...
  \*****************************/
      /***/ (
        ...
        /* harmony import */ var _ajax_api_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          /*! ./ajax/api.js */ "./src/ajax/api.js"
        );
        /* harmony import */ var _modal_Modal_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          /*! ./modal/Modal.js */ "./src/modal/Modal.js"
        );
        /* harmony import */ var _main_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! ./main.js */ "./src/main.js"
        );
        ...
        var editCardForm = function editCardForm(form, userData) {
          ...
          editCardBtn.addEventListener("click", function (event) {
            ...
            var targetElement = document.querySelector(
              ".user-card[userid='".concat(id, "']")
            );
            _modal_Modal_js__WEBPACK_IMPORTED_MODULE_1__.default.hide();
            (0,
            _ajax_api_js__WEBPACK_IMPORTED_MODULE_0__.editVisitCard)(newUserData, id);
            (0,
            _main_js__WEBPACK_IMPORTED_MODULE_2__.updateCard)(id, targetElement.parentNode);
          });
        };
          ...
          _createClass(ButtonForm, [
            {
              ...
              value: function render() {
                var element = this.createElement(
                  "button",
                  ["btn", "btn-modal"].concat(
                    _toConsumableArray(this.classNames)
                  )
                );
                return element;
              },
          ...
          _createClass(Select, [
            {
              ...
              value: function render() {
                ...
                var optionDisabled = this.createElement(
                  "option",
                  [],
                  optionSelectArr[0],
                  optionSelectArr[0],
                ...
                selectEl.append.apply(
                  selectEl,
                  [optionDisabled].concat(_toConsumableArray(selOptionsSplice))
                );
                return selectEl;
              },
            },
  ...
  \*********************/
      /***/ (
        ...
        /* harmony import */ var _modal_Modal_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          /*! ./modal/Modal.js */ "./src/modal/Modal.js"
        );
        /* harmony import */ var _Card_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          /*! ./Card.js */ "./src/Card.js"
        );
        /* harmony import */ var _register_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! ./register.js */ "./src/register.js"
        );
        /* harmony import */ var _ajax_api_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          /*! ./ajax/api.js */ "./src/ajax/api.js"
        );
        /* harmony import */ var _Form_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          /*! ./Form.js */ "./src/Form.js"
        );
        /* harmony import */ var _modal_manualContent_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
          /*! ./modal/manualContent.js */ "./src/modal/manualContent.js"
        );
        ...
        manualLink.addEventListener("click", function (event) {
          event.preventDefault();
          _modal_Modal_js__WEBPACK_IMPORTED_MODULE_0__.default.show(
            "User manual",
            (0, _modal_manualContent_js__WEBPACK_IMPORTED_MODULE_5__.manual)()
          );
        }); // =================== LOADER ==============================================
        ...
        btnenter.addEventListener("click", function () {
          _modal_Modal_js__WEBPACK_IMPORTED_MODULE_0__.default.show(
            "Enter your details",
            _Form_js__WEBPACK_IMPORTED_MODULE_4__.createRegisterForm.render()
          );
          ...
          var inputPasswordlEl = document.querySelector(
            '.input[type="password"]'
          );
                      ...
                      switch ((_context.prev = _context.next)) {
                        ...
                        case 10:
                          ...
                          tooltipEmail.textContent =
                            "You did not enter correct email";
                          setTimeout(function () {
                            return (tooltipEmail.textContent = "");
                          }, 2000);
                          return _context.abrupt("return");
                        ...
                        case 20:
                          _context.next = 22;
                          return (0,
                          _register_js__WEBPACK_IMPORTED_MODULE_2__.register)(
                            email,
                            password
                          );
                        ...
                        case 22:
                          ...
                          if (
                            !(
                              !regToken ||
                              regToken === "Incorrect username or password"
                            )
                          ) {
                            _context.next = 29;
                            break;
                          ...
                          _modal_Modal_js__WEBPACK_IMPORTED_MODULE_0__.default.show(
                            ...
                            (0,
                            _register_js__WEBPACK_IMPORTED_MODULE_2__.registerMessage)(
                        ...
                        case 29:
                          if (regToken) {
                            ...
                            headerText.innerText = sessionStorage.getItem(
                              "email"
                            );
                            btncreate.classList.add("btn-create-show");
                            btnenter.remove();
        ...
        btncreate.addEventListener("click", function () {
          _modal_Modal_js__WEBPACK_IMPORTED_MODULE_0__.default.show(
            "Create visit form",
            _Form_js__WEBPACK_IMPORTED_MODULE_4__.createVisitForm.render()
          );
          ...
          modalSelect.addEventListener("change", function () {
            ...
            _Form_js__WEBPACK_IMPORTED_MODULE_4__.createVisitForm.showCustomeFields(
              modalSelect.value
            );
            ...
            createCardBtn.addEventListener("click", function (event) {
              ...
              (0, _ajax_api_js__WEBPACK_IMPORTED_MODULE_3__.createVisitCard)(
                userData
              ).then(function (newCarddata) {
                var newCard = new _Card_js__WEBPACK_IMPORTED_MODULE_1__.default(
                  newCarddata
                );
                ...
                while (1) {
                  switch ((_context3.prev = _context3.next)) {
                    case 0:
                      ...
                      _context3.next = 3;
                      return (0,
                      _ajax_api_js__WEBPACK_IMPORTED_MODULE_3__.getCards)();
                                  ...
                                  function _callee2$(_context2) {
                                    while (1) {
                                      switch (
                                        ...
                                        case 0:
                                          newCard = new _Card_js__WEBPACK_IMPORTED_MODULE_1__.default(
                                            cardData
                                          );
                ...
                while (1) {
                  switch ((_context4.prev = _context4.next)) {
                    case 0:
                      _context4.next = 2;
                      return (0,
                      _ajax_api_js__WEBPACK_IMPORTED_MODULE_3__.getCard)(id);
        ...
        function _displaySearchResults() {
          _displaySearchResults = _asyncToGenerator(
            /*#__PURE__*/ regeneratorRuntime.mark(function _callee5(serchData) {
              var _serchData,
                searchText,
                searchPriority,
                searchStatus,
              ...
              return regeneratorRuntime.wrap(function _callee5$(_context5) {
                while (1) {
                  switch ((_context5.prev = _context5.next)) {
                    case 0:
                      (_serchData = _slicedToArray(serchData, 4)),
                        (searchText = _serchData[0]),
                        (searchPriority = _serchData[1]),
                        (searchStatus = _serchData[2]),
                        (searchSpecialist = _serchData[3]); // Создаем пустые массивы для хранения карточек выборки по нужному элементу
                    ...
                    case 7:
                      ...
                      if (searchText) {
                        ...
                        cards.forEach(function (card) {
                          ...
                          var isResult = userNameToLowerCase.match(
                            searchRegExp
                          );
                      ...
                      if (searchPriority !== "none") {
                        filtered_priority = filtered_Names.filter(function (
                          card
                        ) {
                      ...
                      if (searchStatus !== "none") {
                        filtered_status = filtered_priority.filter(function (
                          card
                        ) {
                      ...
                      if (searchSpecialist !== "none") {
                        filtered_specialists = filtered_status.filter(function (
                          card
                        ) {
        ...
        var Modal = /*#__PURE__*/ (function (_Component) {
          ...
          _createClass(Modal, [
            ...
            },
            {
              key: "render",
              value: function render() {
                this.modalWrapper = this.createElement("div", [
                  "modal-wrapper",
                ]);
                ...
                this.modalHeader.append(
                  this.modalHeaderContent,
                  this.modalHeaderClose
                );
  ...
  \*************************/
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          ...
          /* harmony export */ registerMessage: () =>
            /* binding */ registerMessage,
          /* harmony export */
        });
        /* harmony import */ var _modal_Modal_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          /*! ./modal/Modal.js */ "./src/modal/Modal.js"
  ...
  \****************************/
      /***/ (
        ...
        /* harmony import */ var _formComponents_Span_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
          /*! ../formComponents/Span.js */ "./src/formComponents/Span.js"
        );
        function _typeof(obj) {
          "@babel/helpers - typeof";
          if (
          ...
          _createClass(Visit, [
            {
              ...
              value: function renderSelect() {
                ...
                if (this.selectSettings.label) {
                  this.selectLabel = this.createElement("span", [
                    "_info-title",
                  ]);
                ...
                this.generalSelect = new _formComponents_Select_js__WEBPACK_IMPORTED_MODULE_3__.default(
                  this.selectSettings
                ).render();
              ...
              value: function renderFields() {
                ...
                var items = this.config.map(function (configItem) {
                  ...
                  if (configItem.elType === "input") {
                    ...
                    element = new _formComponents_Span_js__WEBPACK_IMPORTED_MODULE_5__.default(
                      configItem.options
                    ).render();
                ...
                (_this$generalFieldsCo = this
                  .generalFieldsContainer).append.apply(
                  _this$generalFieldsCo,
                  _toConsumableArray(items)
                );
  ...
  \****************************************/
      /***/ (
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ cardiologistFields: () =>
            /* binding */ cardiologistFields,
          /* harmony export */
        });
        /* harmony import */ var _Component_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          /*! ../Component.js */ "./src/Component.js"
          ...
          _createClass(VisitCardiologist, [
            ...
            },
            {
              ...
              value: function render() {
                ...
                (_this$customeFieldsCo = this
                  .customeFieldsContainer).append.apply(
                  _this$customeFieldsCo,
                  _toConsumableArray(items)
                );
  ...
  \***********************************/
      /***/ (
        ...
        /* harmony import */ var _formComponents_Select_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! ../formComponents/Select.js */ "./src/formComponents/Select.js"
        );
        /* harmony import */ var _formComponents_Textarea_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          /*! ../formComponents/Textarea.js */ "./src/formComponents/Textarea.js"
        );
        /* harmony import */ var _formComponents_Span_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          /*! ../formComponents/Span.js */ "./src/formComponents/Span.js"
        );
        function _typeof(obj) {
          "@babel/helpers - typeof";
              ...
              value: function render() {
                ...
                var items = this.config.map(function (configItem) {
                  ...
                  if (configItem.elType === "input") {
                    ...
                    element = new _formComponents_Select_js__WEBPACK_IMPORTED_MODULE_2__.default(
                      configItem.options
                    ).render();
                  } else if (configItem.elType === "textarea") {
                    element = new _formComponents_Textarea_js__WEBPACK_IMPORTED_MODULE_3__.default(
                      configItem.options
                    ).render();
                    element.placeholder = configItem.placeholder;
                  } else if (configItem.elType === "span") {
                    element = new _formComponents_Span_js__WEBPACK_IMPORTED_MODULE_4__.default(
                      configItem.options
                    ).render();
                    element.placeholder = configItem.placeholder;
                    element.innerHTML = configItem.innerHTML;
  ...
  \*************************************/
      /***/ (
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ therapistFields: () =>
            /* binding */ therapistFields,
          /* harmony export */
        });
        /* harmony import */ var _Component_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          /*! ../Component.js */ "./src/Component.js"
