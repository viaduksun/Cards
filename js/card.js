...
import { deleteVisitCard } from "./ajax/api.js";
import { getCards } from "./ajax/api.js";
...
import { generalFields } from "./visit/Visit.js";
import { editUserCard } from "./formEditUserData.js";
...
class Card extends Component {
  ...
  showAllFields() {
    ...
    const fieldsArray = Object.values(this.userData);
    // allFieldsArray.splice(3, 1);
    // console.log(allFieldsArray);
    // console.log(fieldsArray);
    // console.log(Object.entries(this.userData));
    ...
    // console.log(filteredUserDataArr);
  ...
  renderBody() {
    ...
    // this.body.setAttribute('userId', this.userData.id)
  ...
  //   const visitDetails = new VisitDetails(details);
  //   this.body.append(visitDetails.render());
  // }
  renderFooter() {
    ...
    // priorityDotsContainer.append(dot, dot, dot);
    ...
    // priorityDotsContainer.innerHTML = `${dots}`;
